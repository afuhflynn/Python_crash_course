...
Thank you for considering contributing to **Python Crash Course**! We welcome improvements, new lessons, fixes, and ideas.
...
2. **Clone** your fork locally:
   ...
   ```bash
   git clone https://github.com/your-username/python_crash_course.git
...
* Include practical examples in `<lesson_name>.py`.
